...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://telegram.me/MOVIESNSERIESSNS2'),
            InlineKeyboardButton(text="⚡LATEST MOVIES⚡", url='https://t.me/+lM2prfjyQnRmMDll')
        ]
    )
