...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('MAIN CHANNEL', url='https://telegram.me/MOVIESNSERIESSNS')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/MOVIESNSERIESSNS2"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
             ...
             InlineKeyboardButton('🙆🏻OWNER 🦾', url='https://t.me/SNSNS01'),
            InlineKeyboardButton('GRP️', url='https://t.me/SNSFLIX'),
            InlineKeyboardButton('GRP2', url='https://t.me/MOVIESNSERIESGROUPSNS')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
             ...
             InlineKeyboardButton('🙆🏻OWNER 🦾', url='https://t.me/SNSNS01'),
            InlineKeyboardButton('GRP️1', url='https://t.me/SNSFLIX'),
            InlineKeyboardButton('GRP2', url='https://t.me/MOVIESNSERIESGROUPSNS')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_photo(
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('OWNER', url='https://t.me/SNSNS01)],
        [InlineKeyboardButton('UPDATES', url='https://t.me/MOVIESNSERIESSNS2),
        InlineKeyboardButton('MAIN CHANNEL', url='https://t.me/MOVIESNSERIESSNS)] ] )
        protect_content=True if pre == 'filep' else False,
        )
